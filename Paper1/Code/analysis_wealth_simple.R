...
p1 <- results %>%
    ...
    coord_flip() + labs(title = "Effect of wealth on propensity to vote in favor of Laws", 
                        subtitle = TeX("Model: $y_i = \\alpha + \\beta_1 \\cdot log (1+W_i) + \\beta_2 \\cdot PolParty_i + \\epsilon_i$"),
                        y = "Coefficient magnitude", x = "Law") 

ggsave("./Figures/effectsizes_simplemodel.png", p1, width = 25, units = "cm")
