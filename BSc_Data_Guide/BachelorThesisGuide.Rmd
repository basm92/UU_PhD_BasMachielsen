...
Companies <- Companies[!duplicated(Companies[c(4,6)]),]
...
Financial$indic <- 0
Financial$indic[is.element(Financial$`Company name`,
                           number_connections$company_name)] <- 1
...
Now, we can reap the benefits of our work and do some analysis. For example, are firms with political connections more profitable than others?

As a second example, do firms with political connections offer more employment? 
